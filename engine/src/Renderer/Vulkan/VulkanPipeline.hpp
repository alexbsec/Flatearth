...
public:
  FeExpect<void, Error> CreateGraphicsPipeline(
      ...
      VkDescriptorSetLayout *pDescriptorLayouts, uint32 stageCount,
      VkPipelineShaderStageCreateInfo *pStages, VkViewport viewport,
      VkRect2D scissor, bool isWireframe, Pipeline *pPipeline);
