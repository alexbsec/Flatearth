...
public:
  ...
  FeExpect<void, Error> CreateVulkanBuffer(Context &ctx, uint64 size,
  ...
  FeExpect<void, Error> ResizeBuffer(Context &ctx, uint64 newSize,
                                     VulkanBuffer &buffer, VkQueue queue,
                                     VkCommandPool pool);

  FeExpect<void, Error> BindBuffer(Context &ctx, VulkanBuffer &buffer,
                                   uint64 offset);

  FeExpect<void *, Error> LockMemory(Context &ctx, VulkanBuffer &buffer,
                                     uint64 offset, uint64 size, uint32 flags);
  void UnlockMemory(Context &ctx, VulkanBuffer &buffer);

  FeExpect<void, Error> LoadData(Context &ctx, VulkanBuffer &buffer,
                                 uint64 offset, uint64 size, uint32 flags,
                                 const void *data);
  ...
  FeExpect<void, Error> CopyBufferTo(Context &ctx, VkCommandPool pool,
                                     ...
                                     VkBuffer dest, uint64 destOffset,
                                     uint64 size);
